...
class DeConvNet( object ):
    ...
    def __init__( self, model_name="plankton_conv_visualize_model.pkl.params"):
        ...
        layer1 = ConvPoolLayer( input = layer0.output, image_shape = (1,128,12,12), 
                                filter_shape = (256,128,5,5), W = layer1_w, 
                                b = layer1_b, poolsize=(2, 2), 
                                activation = relu_nonlinear)
        
        layer2 = ConvPoolLayer( input = layer1.output, image_shape = (1,256,4,4), 
                                filter_shape = (512,256,3,3), W = layer2_w, 
        ...
        up_layer0 = CPRStage_Up( image_shape = (1,NUM_C,28,28), filter_shape = (128,NUM_C,5,5),
                            poolsize = 2 , W = layer0_w, b = layer0_b, 
                            activation = activation)
                            
        up_layer1 = CPRStage_Up( image_shape = (1,128,12,12), filter_shape = (256,128,5,5), 
                            poolsize = 2,W = layer1_w, b = layer1_b ,
                            activation = activation)
                            
        up_layer2 = CPRStage_Up( image_shape = (1,256,4,4), filter_shape = (512,256,3,3), 
                            poolsize = 2,W = layer2_w, b = layer2_b ,
                            activation = activation)
        # backward
        down_layer2 = CPRStage_Down( image_shape = (1,512,2,2), filter_shape = (256,512,3,3), 
                                poolsize = 2,W =layer2_w, b = layer2_b,
                                activation = activation)
                                
        down_layer1 = CPRStage_Down( image_shape = (1,256,4*2,4*2), filter_shape = (128,256,5,5), 
                                poolsize = 2,W =layer1_w, b = layer1_b,
                                activation = activation)
                                
        down_layer0 = CPRStage_Down( image_shape = (1,128,28-4,28-4), filter_shape = (NUM_C,128,5,5), 
                                poolsize = 2,W = layer0_w, b = layer0_b,
                                activation = activation)                    
